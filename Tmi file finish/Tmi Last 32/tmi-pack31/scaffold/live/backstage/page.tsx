  ...
  return (
    <div style={{minHeight:"100vh",background:"#0D0520",color:"#fff",fontFamily:"Inter,sans-serif",padding:32}}>
      <div style={{maxWidth:960,margin:"0 auto"}}>
        ...
        <p style={{color:"#C8A8E8",fontSize:14,marginBottom:24}}>Live backstage surface.</p>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          <a href="/live" style={{display:"block",padding:"8px 12px",marginBottom:4,background:"#150830",border:"1px solid rgba(0,229,255,0.2)",borderRadius:6,color:"#00E5FF",textDecoration:"none",fontSize:12,fontFamily:"Oswald,sans-serif",letterSpacing:1}}>→ Back to Live</a>
        </div>
      </div>
    </div>
  );
