    ...
    <div style={{minHeight:"100vh",background:"#0D0520",color:"#fff",fontFamily:"Inter,sans-serif",padding:32}}>
      <div style={{maxWidth:960,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          <a href="/dashboard/fan" style={{display:"block",padding:"8px 12px",marginBottom:4,background:"#150830",border:"1px solid rgba(0,229,255,0.2)",borderRadius:6,color:"#00E5FF",textDecoration:"none",fontSize:12,fontFamily:"Oswald,sans-serif",letterSpacing:1}}>→ Back to Dashboard</a>
        </div>
      </div>
    </div>
  );
