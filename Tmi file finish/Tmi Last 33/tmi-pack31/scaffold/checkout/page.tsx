  ...
  return (
    <div style={{minHeight:"100vh",background:"#0D0520",color:"#fff",fontFamily:"Inter,sans-serif",padding:32}}>
      <div style={{maxWidth:960,margin:"0 auto"}}>
        ...
        <h1 style={{fontFamily:"'Bebas Neue',Impact,sans-serif",fontSize:36,color:"#7A5F9A",letterSpacing:2,margin:"0 0 8px"}}>
          CHECKOUT
        </h1>
        <p style={{color:"#C8A8E8",fontSize:14,marginBottom:24}}>🚩 Feature flag: enableCreatorStore=false — this page is scaffolded but not active yet.</p>
        <div style={{background:"#150830",border:"1px solid rgba(0,229,255,0.25)",borderRadius:12,padding:24,marginBottom:24}}>
