...
export const metadata: Metadata = {
  title: 'Grand Platform Contest | The Musician\'s Index',
  description: 'The BerntoutGlobal Grand Platform Contest — compete for the grand prize across all creator categories.',
};
      ...
      <section className="sponsor-preview">
        ...
        <div className="packages-row">
          {[
            ...
            <div key={pkg.tier} className="pkg-preview-card" style={{ '--pkg-color': pkg.color } as React.CSSProperties}>
