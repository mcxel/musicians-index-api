...
const metrics = [
  ...
  { label: 'RUBY', value: '920', tone: 'white' as const },
...
const rows = [
  ...
  { primary: 'RUBY to Gold Ladder', secondary: 'mid-tier upgrades and retention', status: 'stable', value: '3,030', chips: ['RUBY', 'gold'] },
...
export default function AdminSubscriptionsPage() {
  return (
    <AdminOpsConsole
      ...
      subtitle="Subscription oversight for free, pro, RUBY, gold, platinum, diamond, gifted, and trial tiers."
      metrics={metrics}
