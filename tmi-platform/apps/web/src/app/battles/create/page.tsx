...
const BATTLE_TYPES = [
  ...
  { id: "acapella-battle", label: "Acapella Only", class: "vocal" },
  { id: "byob", label: "Bring Your Own Beat", class: "vocal" },
  ...
  { id: "producer-mc", label: "Producer + MC", class: "production" },
  { id: "dj-mc", label: "DJ + MC", class: "production" },
  { id: "beat-submission", label: "Beat Submission", class: "production" },
  { id: "flip-battle", label: "Sample Flip Battle", class: "production" },
