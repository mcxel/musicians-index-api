...
const RULES = [
  ...
  { section: "4. Sponsor Rules", body: "Self-sponsorship is strictly prohibited. Each sponsor may only be counted once per entry. Sponsor payments must clear verification before being counted. Minimum: Local RUBY $50, Major RUBY $1,000." },
