  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white px-6 py-10">
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "clamp(22px,4vw,34px)", fontWeight: 900, color: "#38BDF8", margin: "0 0 10px" }}>Media Manager</h1>
        <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", marginBottom: 32 }}>Upload, tag, and manage platform media assets, cover art, and video content.</p>
