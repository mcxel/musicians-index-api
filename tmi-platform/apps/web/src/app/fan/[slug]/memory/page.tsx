...
type FanMemoryPageProps = {
  params: Promise<{ slug: string }>;
};

export default async function FanMemoryPage({ params }: FanMemoryPageProps) {
  ...
  const topMemories = getTopMemories(slug, 'fan', 5);
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#050510', color: '#fff', padding: 20 }}>
      <div style={{ maxWidth: 960, margin: '0 auto', display: 'grid', gap: 14 }}>
        ...
        <h1 style={{ margin: 0 }}>Fan Memory Wall</h1>
        <div
          style={{
            display: 'grid',
