...
const CFG = { label: 'Fan', accent: '#00FFFF', hub: '/hub/fan' };

export default function FanSettingsPage() {
  const [notifs, setNotifs] = useState({ battles: true, messages: true, revenue: false, news: true });
    ...
    <div style={{ minHeight: '100vh', background: '#07071a', color: '#fff', fontFamily: 'sans-serif', padding: '2rem' }}>
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <Section title="Account" accent={CFG.accent}>
          ...
          <SaveBtn accent={CFG.accent} label="Update Account" dark />
        </Section>
...
function SaveBtn({ accent, label, dark }: { accent: string; label: string; dark?: boolean }) {
  return (
