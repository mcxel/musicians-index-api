...
export const metadata = { title: "Quizzes — TMI Games" };
  ...
  return (
    <main className="min-h-screen bg-black text-zinc-100 px-4 py-10 max-w-2xl mx-auto">
      ...
      <div className="rounded-xl border border-violet-400/40 bg-black/60 p-6">
        ...
        <h1 className="mb-2 text-2xl font-black uppercase tracking-tight text-white">Quizzes</h1>
        <p className="mb-4 text-sm text-zinc-300 leading-relaxed">
          Music knowledge, platform lore, and pop culture rapid-fire rounds. Compete solo or with teams.
          Top scorers go on the weekly leaderboard and earn Crown Point bonuses.
        </p>
        <div className="mb-5 rounded border border-violet-300/25 bg-violet-500/10 px-3 py-2 text-[11px] font-bold text-violet-100">
          +40 pts per win · Team or solo · Weekly leaderboard
        </div>
        <Link
          href="/games/trivia"
