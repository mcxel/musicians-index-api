...
export default function StreamAndWinPage() {
  return (
    <main className="min-h-screen bg-black text-zinc-100 px-4 py-10 max-w-2xl mx-auto">
      ...
      <div className="rounded-xl border border-cyan-400/40 bg-black/60 p-6">
        ...
        <h1 className="mb-2 text-2xl font-black uppercase tracking-tight text-white">Stream &amp; Win</h1>
        <p className="mb-4 text-sm text-zinc-300 leading-relaxed">
          Watch live TMI content and earn Crown Points passively. Every 5 minutes of verified watch time
          grants point rewards. Bonus multipliers during Crown Qualifier streams.
        </p>
