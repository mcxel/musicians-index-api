...
const MAGAZINE_PAGES = [
  ...
  { id: 2, label: "Wavetek's Rise",                  route: magazineReaderArticleUrl("wavetek-rise-billboard", { from: "/home/magazine" }),             bg: "radial-gradient(circle at 55% 25%, rgba(0,255,255,0.08) 0%, transparent 55%), radial-gradient(circle at 75% 70%, rgba(255,45,170,0.12) 0%, transparent 50%), linear-gradient(170deg,#050510,#0a0c22)", accent: "#00FFFF", teaser: "How the Houston rapper built a $2M streaming empire in 18 months — with zero label and zero promotion budget." },
  { id: 3, label: "Neon Vibe Interview",             route: magazineReaderArticleUrl("neon-vibe-monday-stage", { from: "/home/magazine" }),             bg: "radial-gradient(circle at 75% 25%, rgba(255,45,170,0.12) 0%, transparent 55%), linear-gradient(170deg,#050510,#080515)", accent: "#FF2DAA", teaser: "Inside the Monday Stage residency that fans are calling 'The Neon Church.' A DJ/producer redefining live electronic music." },
  { id: 4, label: "Zuri Bloom Feature",              route: magazineReaderArticleUrl("zuri-bloom-afrobeats-future", { from: "/home/magazine" }),        bg: "radial-gradient(circle at 50% 0%, rgba(0,255,136,0.12) 0%, transparent 55%), linear-gradient(170deg,#050510,#051209)", accent: "#00FF88",  teaser: "24 years old. Two continents. One sound. Zuri Bloom is bridging Lagos and Los Angeles one song at a time." },
  { id: 5, label: "TMI Grand Contest Preview",       route: magazineReaderArticleUrl("tmi-grand-contest-season-1", { from: "/home/magazine" }), bg: "radial-gradient(circle at 80% 60%, rgba(255,215,0,0.12) 0%, transparent 55%), linear-gradient(170deg,#050510,#0b0a1b)",  accent: "#FFD700", teaser: "Everything you need to know about Season 1. Categories, prize pools, and how the crown is earned." },
  { id: 6, label: "Monday Cypher: Bars Born Here",  route: magazineReaderArticleUrl("monday-cypher-bars-born", { from: "/home/magazine" }),            bg: "radial-gradient(circle at 20% 80%, rgba(0,255,136,0.12) 0%, transparent 55%), linear-gradient(170deg,#050510,#050c07)", accent: "#00FF88",  teaser: "TMI's weekly freestyle session draws 15,000+ viewers. Three participants have since signed major deals." },
];
