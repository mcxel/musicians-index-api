...
const PERFORMER_TIERS = [
  ...
  },
  {
    ...
    color: '#FF9500',
    price: '$16.99/mo',
    badge: 'BANDS' as string | null,
    perks: ['Band profile + group page', 'Music uploads + event listings', 'Booking inquiries + livestreams', 'Messaging + playlist support', 'Basic analytics'],
    cta: 'START BAND PRO',
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_BAND_PRO ?? ''}&mode=subscription&amount=1699&productName=TMI+Band+Pro`,
    highlighted: false,
  },
  {
    key: 'band-gold',
    ...
    color: '#FFD700',
    price: '$20.00/mo',
    badge: 'CREATIVE SUITE' as string | null,
    perks: ['Everything in Band Pro', 'Full Creative Studio unlock', 'Poster/flyer/magazine creators', 'Retro Vision + keepsake studio', 'Advanced analytics + priority discovery'],
    cta: 'UPGRADE TO BAND GOLD',
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_BAND_GOLD ?? ''}&mode=subscription&amount=2000&productName=TMI+Band+Gold`,
    highlighted: false,
  },
  {
    key: 'band-platinum',
    ...
    price: '$29.99/mo',
    badge: null as string | null,
    perks: ['Everything in Band Gold', 'Premium templates + campaign tools', 'Higher upload/storage limits', 'Premium placement opportunities'],
    cta: 'UPGRADE TO BAND PLATINUM',
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_BAND_PLATINUM ?? ''}&mode=subscription&amount=2999&productName=TMI+Band+Platinum`,
    highlighted: false,
  },
  {
    key: 'band-diamond',
    ...
    price: '$39.99/mo',
    badge: null as string | null,
    perks: ['Everything in Band Platinum', 'Highest priority discovery', 'Diamond spotlight eligibility', 'VIP support lane'],
    cta: 'GO BAND DIAMOND',
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_BAND_DIAMOND ?? ''}&mode=subscription&amount=3999&productName=TMI+Band+Diamond`,
    highlighted: false,
  },
];
...
const ADVERTISER_ENTRY = [
  {
    ...
    cta: 'RUN MICRO AD',
    ctaHref: '/api/stripe/checkout?product=AD_TICKER_MONTHLY&mode=payment',
  },
  {
    key: 'ad-local',
    name: 'LOCAL SHOUTOUT',
    ...
    cta: 'GET SHOUTOUT',
    ctaHref: '/api/stripe/checkout?product=AD_BANNER_MONTHLY&mode=payment',
  },
  {
    key: 'ad-playlist',
    name: 'PLAYLIST BOOST',
    ...
    cta: 'BOOST PLAYLIST',
    ctaHref: '/api/stripe/checkout?product=AD_BILLBOARD_WEEKLY&mode=payment',
  },
  {
    key: 'ad-sidebar',
    name: 'SIDEBAR AD',
    ...
    ctaHref: '/api/stripe/checkout?product=AD_VIDEO_WEEKLY&mode=payment',
  },
] as const;
...
const SUPPORT_TIERS = [
  {
    ...
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_SUPPORT_BASIC ?? ''}&mode=subscription&amount=299&productName=Support+This+Performer`,
  },
  {
    key: 'super-supporter',
    ...
    ctaHref: `/api/stripe/checkout?priceId=${process.env.NEXT_PUBLIC_STRIPE_PRICE_SUPPORT_SUPER ?? ''}&mode=subscription&amount=499&productName=TMI+Super+Supporter`,
  },
] as const;
