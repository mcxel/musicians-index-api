  ...
  return (
    <main style={{ minHeight: "100vh", background: "#050510", color: "#fff", padding: "34px 18px" }}>
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 14 }}><Link href="/face-login" style={{ color: "#FFD700", textDecoration: "none", fontSize: 12 }}>Camera</Link><Link href="/device-trust" style={{ color: "#AA2DFF", textDecoration: "none", fontSize: 12 }}>Device</Link><Link href="/messages" style={{ color: "#FF2DAA", textDecoration: "none", fontSize: 12 }}>Messages</Link><Link href="/friends" style={{ color: "#00FF88", textDecoration: "none", fontSize: 12 }}>Followers</Link><Link href="/articles" style={{ color: "#00FFFF", textDecoration: "none", fontSize: 12 }}>Articles</Link><Link href="/memories" style={{ color: "#FFD700", textDecoration: "none", fontSize: 12 }}>Memories</Link><Link href="/tickets" style={{ color: "#AA2DFF", textDecoration: "none", fontSize: 12 }}>Tickets</Link><Link href="/beats" style={{ color: "#FF2DAA", textDecoration: "none", fontSize: 12 }}>Beats</Link><Link href="/live/rooms" style={{ color: "#00FF88", textDecoration: "none", fontSize: 12 }}>Rooms</Link></div><div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 10, marginTop: 18 }}>
