  ...
  return (
    <main style={{ minHeight: "100vh", background: "#050510", color: "#fff", padding: "32px 24px 80px" }}>
      <div style={{ marginBottom: 10 }}>
        <Link href="/dashboard/sponsor" style={{ color: "#FF2DAA", fontSize: 11, fontWeight: 700, textDecoration: "none", letterSpacing: 3 }}>← SPONSOR HUB</Link>
      </div>
      <div style={{ marginBottom: 36 }}>
        <div style={{ fontSize: 10, letterSpacing: 5, color: "#FF2DAA", fontWeight: 800, marginBottom: 4 }}>SPONSORSHIP PACKAGES</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 16, maxWidth: 960, margin: "0 auto" }}>
        {PACKAGES.map((pkg) => (
          <div key={pkg.id} style={{
            ...
            <div style={{ fontSize: 28, fontWeight: 900, marginBottom: 20, color: "#fff" }}>{pkg.price}</div>
