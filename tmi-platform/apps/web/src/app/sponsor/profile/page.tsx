...
const STATS = [
  { label: "Active Campaigns", value: "0",  color: ACCENT    },
  { label: "Impressions",      value: "0",  color: "#00FFFF" },
  { label: "Artists Backed",   value: "0",  color: "#AA2DFF" },
  { label: "Budget Deployed",  value: "$0", color: "#FF2DAA" },
  { label: "Avg Engagement",   value: "—",  color: "#00FF88" },
  { label: "ROI",              value: "—",  color: ACCENT    },
];
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1000, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 20 }}>
          <div style={{ padding: "18px 20px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14 }}>
            ...
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", textAlign: "center", padding: "14px 0" }}>No campaigns yet — <Link href="/sponsor/campaigns" style={{ color: ACCENT, textDecoration: "none" }}>create one</Link></p>
          </div>
          <div style={{ padding: "18px 20px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14 }}>
            <div style={{ fontSize: 9, letterSpacing: "0.2em", color: ACCENT, fontWeight: 800, marginBottom: 12 }}>SPONSORED ARTISTS</div>
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", textAlign: "center", padding: "14px 0" }}>No sponsorships yet.</p>
          </div>
        </div>
