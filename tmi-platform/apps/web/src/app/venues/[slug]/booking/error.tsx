...
export default function VenueBookingError({
  error,
  reset,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#07040a] px-6 py-10 text-white">
      <div className="mx-auto max-w-4xl rounded-3xl border border-rose-400/30 bg-rose-950/15 p-6">
        <p className="text-xs uppercase tracking-[0.18em] text-rose-300">Venue Booking Error</p>
        <h1 className="mt-2 text-2xl font-black tracking-[0.04em]">Route Recovery Required</h1>
        <p className="mt-3 text-sm text-slate-300">A recoverable error occurred while loading this venue booking surface.</p>
        {error?.message && (
