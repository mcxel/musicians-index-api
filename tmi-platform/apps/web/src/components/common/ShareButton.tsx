...
import { SocialBrandIcon } from "@/components/brands/SocialBrandIconRegistry";
          ...
          >
            {platforms.map((p) =>
              p.href ? (
                ...
                >
                  <span style={{ width: 18, textAlign: "center", fontWeight: 900, fontSize: 11 }}>
                    {p.brand ? <SocialBrandIcon brand={p.brand} size={14} /> : p.icon}
                  </span>
                  {p.label}
                </a>
              ) : (
                <button key={p.label} type="button" onClick={p.onClick} style={itemStyle}>
                  <span style={{ width: 18, textAlign: "center", fontWeight: 900, fontSize: 11 }}>
                    {p.brand ? <SocialBrandIcon brand={p.brand} size={14} /> : p.icon}
                  </span>
                  {p.label}
