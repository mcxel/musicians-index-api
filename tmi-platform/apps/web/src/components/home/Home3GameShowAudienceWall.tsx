...
const GAME_SHOWS = [
  {
    ...
    href: "/live/rooms/dealer-feud-1000?from=lobby-wall",
    accent: "#FFD700",
    icon: "🎯",
    audienceSize: 2400,
    prizePool: "$1,000",
  ...
  },
  {
    ...
    href: "/live/rooms/monthly-idol?from=lobby-wall",
    accent: "#FF2DAA",
    icon: "⭐",
    audienceSize: 3100,
    prizePool: "$5,000",
  ...
  },
  {
    ...
    href: "/live/rooms/circles-and-squares?from=lobby-wall",
    accent: "#AA2DFF",
    icon: "⬛",
    audienceSize: 1800,
    prizePool: "$1,000",
  ...
  },
  {
    ...
    href: "/live/rooms/monday-night-stage?from=lobby-wall",
    accent: "#00FFFF",
    icon: "🎶",
    audienceSize: 4200,
    prizePool: "$3,500",
  ...
  },
  {
    ...
    href: "/live/rooms/world-dance-party?from=lobby-wall",
    accent: "#FF6B35",
    icon: "💃",
    audienceSize: 5800,
    prizePool: "$4,000",
  ...
  },
  {
    ...
    href: "/live/rooms/name-that-tune?from=lobby-wall",
    accent: "#00FF88",
    icon: "🎵",
    audienceSize: 2200,
    prizePool: "$1,500",
