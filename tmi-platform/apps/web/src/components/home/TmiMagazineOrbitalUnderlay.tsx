...
const ORBIT_NODES = [
  { rank: "#1", contextRank: "#1 Global DJ", name: "ASTRA NOVA", genre: "DJ / Turntablist", color: "#FF2DAA", live: true, audienceCount: 1284, countryFlag: "🇺🇸", countryCode: "USA", countryName: "United States", watchHref: "/live/rooms/dj-astra-nova?from=lobby-wall", profileHref: "/artist/astra-nova" },
  { rank: "#2", contextRank: "#2 Rising DJ", name: "PRISM VEX", genre: "EDM DJ", color: "#FFD700", live: true, audienceCount: 943, countryFlag: "🇬🇧", countryCode: "UK", countryName: "United Kingdom", watchHref: "/live/rooms/prism-vex?from=lobby-wall", profileHref: "/artist/prism-vex" },
  { rank: "#3", contextRank: "#3 DJ Battle Champion", name: "ZION FREQ", genre: "Battle DJ", color: "#00FF7F", live: false, audienceCount: 402, countryFlag: "🇨🇦", countryCode: "CAN", countryName: "Canada", watchHref: "/live/rooms/zion-freq?from=lobby-wall", profileHref: "/artist/zion-freq" },
  { rank: "#4", contextRank: "#4 Comedy Challenge", name: "NOVA LAUGH", genre: "Stand-Up Comedy", color: "#00FFFF", live: true, audienceCount: 611, countryFlag: "🇳🇬", countryCode: "NGA", countryName: "Nigeria", watchHref: "/live/rooms/nova-laugh?from=lobby-wall", profileHref: "/artist/nova-laugh" },
  { rank: "#5", contextRank: "#5 DJ Discovery", name: "FLEX KING", genre: "Open Format DJ", color: "#AA2DFF", live: false, audienceCount: 288, countryFlag: "🇦🇺", countryCode: "AUS", countryName: "Australia", watchHref: "/live/rooms/flex-king?from=lobby-wall", profileHref: "/artist/flex-king" },
  { rank: "#6", contextRank: "#6 Producer Showcase", name: "BEAT GRID", genre: "Producer", color: "#FF8C00", live: false, audienceCount: 198, countryFlag: "🇩🇪", countryCode: "DEU", countryName: "Germany", watchHref: "/live/rooms/beat-grid?from=lobby-wall", profileHref: "/artist/beat-grid" },
  { rank: "#7", contextRank: "#7 Dance-Off Challenge", name: "DANCE CREW", genre: "Dance Crew", color: "#E63000", live: true, audienceCount: 859, countryFlag: "🇧🇷", countryCode: "BRA", countryName: "Brazil", watchHref: "/live/rooms/dance-crew?from=lobby-wall", profileHref: "/artist/dance-crew" },
  { rank: "#8", contextRank: "#8 Afrobeat Discovery", name: "LAGOS BURST", genre: "Afrobeat", color: "#FFD700", live: false, audienceCount: 334, countryFlag: "🇳🇬", countryCode: "NGA", countryName: "Nigeria", watchHref: "/live/rooms/lagos-burst?from=lobby-wall", profileHref: "/artist/lagos-burst" },
  { rank: "#9", contextRank: "#9 Spoken Word Arena", name: "CIPHER SOUL", genre: "Spoken Word", color: "#00FFFF", live: false, audienceCount: 147, countryFlag: "🇿🇦", countryCode: "ZAF", countryName: "South Africa", watchHref: "/live/rooms/cipher-soul?from=lobby-wall", profileHref: "/artist/cipher-soul" },
