  ...
  if (!battle) {
    return (
      <article className="group relative rounded-xl border border-fuchsia-300/35 bg-gradient-to-br from-fuchsia-500/15 via-black/65 to-black/75 p-4">
        ...
        <p className="mt-3 text-[11px] uppercase tracking-[0.1em] text-zinc-400">No battle happening right now</p>
        <Link href="/battles" className="mt-3 inline-block rounded-md border border-fuchsia-300/45 bg-fuchsia-500/20 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.12em] text-fuchsia-100 hover:border-fuchsia-100">Browse Battles</Link>
      </article>
    );
  }
