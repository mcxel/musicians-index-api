...
export interface MediaTrack {
  ...
  title: string;
  artist: string;
  src?: string;       // audio URL (optional — plays silence if absent)
...
export default function MediaPlayer({
  ...
  // Simulated playback tick (for tracks without a real src)
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginTop: 14 }}>
          <button
            ...
            style={{ background: "none", border: "none", cursor: "pointer", fontSize: 14,
              color: shuffle ? accent : "rgba(255,255,255,0.3)" }}
          >🔀</button>
          <button
            onClick={goPrev}
          ...
          <button
            ...
            style={{ background: "none", border: "none", cursor: "pointer", fontSize: 14,
              color: repeat ? accent : "rgba(255,255,255,0.3)" }}
          >🔁</button>
        </div>
      </div>
        ...
        <div style={{ maxHeight: 220, overflowY: "auto" }}>
          {tracks.map((t, i) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 11, fontWeight: i === currentIdx ? 700 : 500,
                  color: i === currentIdx ? "#fff" : "rgba(255,255,255,0.6)",
