...
export const FAN_COSMETIC_CATALOG: FanCosmeticDef[] = [
  ...
  },
  {
    ...
    equipSlot: "accessory",
    certifiedGlb: false,
    description: "Urban bobblehead headwear fit — plate until GLB",
    layerScale: 1.1,
  },
  {
    id: "street_beanie",
    ...
    equipSlot: "accessory",
    certifiedGlb: false,
    description: "Skater/youth beanie slot for bobblehead bases",
    layerScale: 1.12,
  },
  {
    id: "neck_headphones",
    ...
    equipSlot: "accessory",
    certifiedGlb: false,
    description: "Music-fan neck accessory — bobblehead fit template",
  },
