...
export const PERMANENT_BOT_REGISTRY: BotDutyEntry[] = [
  ...
  {
    botId: "performer-lobby-host-bot",
    botClass: "host-bot",
    displayName: "TMI Performer Lobby Host",
    botLabel: "[BOT] TMI Host",
    duties: ["join-public-room", "keep-room-active", "host-event"],
    status: "on-duty",
    currentTask: "keep-room-active",
    safetyFlags: DEFAULT_SAFETY,
    createdAt: Date.now(),
  ...
  {
    botId: "performer-lobby-guide-bot",
    botClass: "helper-bot",
    displayName: "TMI Performer Lobby Guide",
    botLabel: "[BOT] TMI Guide",
    duties: ["join-public-room", "welcome-user", "find-lobby", "keep-room-active"],
    status: "on-duty",
    currentTask: "welcome-user",
    safetyFlags: DEFAULT_SAFETY,
    createdAt: Date.now(),
