...
export const PERFORMER_OPERATING_CENTERS: OperatingCenter[] = [
  {
    ...
    modules: ["messaging", "notifications", "submissions"],
    roles: ["performer"],
  ...
  },
  {
    ...
    modules: ["media_locker", "beat_lab", "playlist", "memory"],
    roles: ["performer"],
  ...
  },
  {
    ...
    icon: "💰",
    accent: "#FFD700",
    primaryModule: "sponsors",
    modules: ["sponsors", "store"],
    roles: ["performer"],
...
export const FAN_OPERATING_CENTERS: OperatingCenter[] = [
  ...
  },
  {
    ...
    modules: ["prize_vault", "inventory", "tickets"],
    roles: ["fan"],
  ...
  },
  {
    ...
    accent: "#FFD700",
    primaryModule: "analytics",
    modules: ["analytics", "scores", "favorites"],
    roles: ["fan"],
