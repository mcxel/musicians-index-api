...
const LAUNCH_ARTICLES: NewsArticle[] = [
  {
    ...
    body: [
      "The Musician's Index Grand Contest Season 1 is now officially underway — and the platform has never sounded this good.",
      "Every week, performers enter live battles and cyphers across TMI's arena rooms. Fans vote in real time, and the rankings update automatically after every round.",
      "Prize pools are funded by sponsors. The more activity in a room, the more money goes into the pot. The cycle is self-sustaining.",
      "Artists can enter CBC — Challenges, Battles, and Cyphers — through their performer hub. Rounds run Thursday through Sunday.",
      "Fans earn XP for every vote, every tip, and every show they watch from start to finish.",
      "At the end of each season, the top-ranked performers compete in the Finals for belts, trophies, and cash payouts distributed through the platform wallet.",
      "Season 1 is accepting new performers now. No experience requirement. The stage is open.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "The Musician's Index is live. Not beta. Not coming soon. Live.",
      "Performers can sign up and go live tonight. Fan voting is active. The giveaway pipeline is running. Sponsors can book prize slots.",
      "Every role on the platform — performer, fan, advertiser, sponsor, venue, and writer — is fully onboarded and operational.",
      "The arena rooms are open: CBC battles, live lobby walls, cypher pits, and stage showcase rooms.",
      "Magazine Issue 1 is in rotation. Stories are live. Writers are being accepted.",
      "If you've been waiting to join, the wait is over. The curtain is up.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "The weekly crown algorithm ran at midnight Sunday. The results are in.",
      "Nova Cipher took the crown for the third consecutive week, posting an 89% fan approval rating across 4 battle rounds.",
      "Second place went to FlowState.J, whose cypher performance in the Underground Pit room generated the highest per-minute vote rate of the season.",
      "Third place: Ari Volt. Ari's tip total this week was the highest on the platform — a signal that fans aren't just voting, they're investing.",
      "The crown comes with platform-wide visibility, a featured article slot, and a sponsor prize draw entry.",
      "Next week's crown competition opens Thursday. Performers, submit your entry in the hub.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "TMI's Live Lobby Walls are open to all registered fans — no paid ticket required for general admission.",
      "Every active performance streams directly into the wall. Fans can react, vote, send tips, and watch replays from the same interface.",
      "The wall updates in real time. When a new room goes live, a card appears. When a battle ends, the wall shows the result.",
      "For premium rooms — VIP showcases, sponsor events, and championship rounds — a viewer pass is required. Pricing starts at $5.",
      "Fans who watch more than 3 shows per week automatically qualify for the Watch & Earn bonus — 250 XP dropped at midnight Sunday.",
      "The lobby wall is the heartbeat of TMI. Come watch.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "CBC stands for Challenges, Battles, and Cyphers — the three competitive formats that run TMI's arena.",
      "Battles are 1v1. Two performers. Two rounds each. Fan vote decides the winner. The loser gets a rematch slot the following week.",
      "Challenges are open-entry rounds with a theme. Any performer on the platform can submit a round. Fans rank submissions. Top 3 move to the Finals.",
      "Cyphers are group formats — 4 to 8 performers in a rotation. No elimination, but ranking points are awarded per round based on crowd energy.",
      "All three formats feed into the Season 1 leaderboard. Points accumulate weekly. The leaderboard resets every 12 weeks.",
      "Entry is free for all performers. Optional buy-in rounds with prize pools are listed in the Events section.",
      "To enter, go to your Performer Hub → Battles & Cyphers → Join Round.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "TMI's ticketing system is live and accepting event listings from verified performers and venue operators.",
      "Each event gets a dedicated page with seat mapping, pricing tiers, and a purchase flow connected directly to Stripe.",
      "Tickets can be digital (email delivery with QR code) or physical (print-on-demand batch for venue door scanning).",
      "The platform takes 10%. Artists keep 90%. There are no monthly fees — you only pay when you sell.",
      "To list your show, go to your Performer Hub → Manage Shows → Create Event.",
      "Venue operators can add their space to the booking directory under their Venue Hub.",
      "The first 50 events listed during soft launch get 0% platform fee on their first night.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "Every time a fan enters a live room on TMI, your ad is already there. Not a banner they scroll past — an integrated placement inside the arena wall.",
      "TMI advertising placements include: lobby wall cards, in-article sponsor slots, battle countdown inserts, and giveaway prize contributions.",
      "Campaign setup takes under 10 minutes. You set the budget. We handle placement targeting by room type, artist genre, and fan tier.",
      "Minimum campaign: $49/week. There are no impressions games here — you're buying time inside a room where people are actively watching.",
      "Sponsors who contribute to prize pools get brand mention on the winner announcement card — seen by everyone who voted.",
      "Start your campaign: go to /advertise and select your placement type.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "TMI is not a social media platform. It is a performance infrastructure.",
      "Artists can go live to global audiences, sell tickets to virtual shows, release beats and instrumentals directly through the store, and mint NFTs tied to their music.",
      "Every performance generates data that feeds into the ranking engine, the magazine, and the season standings.",
      "Concerts on TMI can be free or ticketed. They can be solo or multi-act. They can run for 20 minutes or 4 hours.",
      "Release drops work the same way: create a release, set a price, push it to the store, and let the platform's bots handle promotion.",
      "This is the infrastructure that used to require a label, a manager, and a booking agent. TMI replaces all three.",
    ],
    category: "news",
    templateType: "A",
  ...
  },
  {
    ...
    body: [
      "Every TMI weekly champion's winning performance is preserved on the Replay Wall — a permanent archive of the platform's defining moments.",
      "The Replay Wall lives at /home/3. Fans can browse by season, by artist, or by battle type.",
      "Replays earn ongoing tip revenue for the performer — long after the battle ends. Tips sent during replay go straight to the artist wallet.",
      "The most-replayed performances of all time generate more platform visibility than any ad campaign could buy.",
      "Writers and journalists can embed Replay Wall clips in articles. Every embed tracks back to the original performer's profile.",
      "If you perform this week and win, your round is on the wall by Monday morning.",
    ],
    category: "news",
    templateType: "D",
  ...
  },
  {
    ...
    body: [
      "The Musician's Index Magazine is live and expanding its writing team.",
      "We're looking for reporters who understand music, culture, and live performance. You don't need a journalism degree. You need good instincts and deadline discipline.",
      "Writer roles available: news reporter, artist profile writer, battle recap journalist, sponsored content editor.",
      "Writers are paid per verified published article. Rates start at $25 per piece and scale with readership.",
      "To apply: sign up with the Writer/Reporter role, submit a 200-word sample on any current TMI artist or event, and your application goes to the editorial queue.",
      "All published articles go through the editorial validation engine. Accuracy and originality are checked automatically.",
      "Apply now at /signup?role=artist (select Writer/Reporter) or email the editorial desk at editorial@themusiciansindex.com.",
    ],
    category: "news",
    templateType: "E",
