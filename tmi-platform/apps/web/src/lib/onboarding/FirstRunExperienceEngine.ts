...
const ALL_STEPS: FirstRunStep[] = [
  ...
  {
    id: 'open-action-canister',
    title: 'Open the Action Canister',
    description: 'The icon dock on every live room opens Messages, Bookings, Revenue, Friends, and more. Tap any icon to slide open your personal panel.',
    ctaLabel: 'Enter Fan Theater',
    ctaHref: '/fan/theater',
    xpGrant: 10,
    role: 'all',
  },
  ...
  },
  {
    ...
    description: 'Enter any live room — Fan Theater, World Concert, or Nova Cipher — to watch and interact in real time.',
  ...
  },
  {
    ...
    description: 'Inside a live room, open the 💰 Revenue drawer and tap "Tip Artist". Starts at $1.',
    ctaLabel: 'Go to Fan Theater',
    ctaHref: '/fan/theater',
    xpGrant: 20,
    role: 'fan',
  },
  {
    id: 'fan-subscribe',
    title: 'Subscribe to an Artist',
    description: 'Visit any artist profile and hit Subscribe to unlock backstage rooms, exclusive drops, and direct messaging.',
  ...
  {
    id: 'fan-open-messages',
    title: 'Open Messages',
    description: 'Tap the 💬 icon in the Action Canister to DM artists, join group chats, or video call friends directly from any room.',
  ...
  },
  {
    ...
    description: 'Open your Performer Studio, hit GO LIVE, and start earning tips from fans watching in real time.',
  ...
  {
    id: 'performer-open-revenue',
    title: 'Check Your Revenue Panel',
    description: 'In the studio, open the 💰 Revenue drawer to see tips, subscriptions, ad revenue, and your withdrawal balance.',
    ctaLabel: 'Open Studio',
    ctaHref: '/performer/studio',
    xpGrant: 20,
    role: 'performer',
