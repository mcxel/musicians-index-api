...
export const FAN_COSMETIC_OFFERS: PointsSpendOffer[] = [
  ...
  {
    id: "cosmetic_bh_neck_headphones",
    category: "cosmetics",
    label: "Bobblehead — Neck Headphones",
    pointsCost: 150,
    role: "FAN",
    href: "/store/fan#bobblehead-accessories",
    engine: "BobbleheadBaseRegistry / FanCosmeticCatalog",
    note: "Fit template for music-fan bases — 2D preview until GLB",
  },
  {
    id: "cosmetic_bh_studio_shades",
    category: "cosmetics",
    label: "Bobblehead — Studio Shades",
    pointsCost: 200,
    role: "FAN",
    href: "/store/fan#bobblehead-accessories",
    engine: "BobbleheadBaseRegistry / FanCosmeticCatalog",
  ...
  {
    id: "cosmetic_bh_leather_jacket",
    category: "cosmetics",
    label: "Bobblehead — Outerwear Jacket",
    pointsCost: 299,
    role: "FAN",
    href: "/store/fan#bobblehead-accessories",
    engine: "BobbleheadBaseRegistry / FanCosmeticCatalog",
