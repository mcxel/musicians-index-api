...
export const CREATOR_ITEMS: StoreItem[] = [
  ...
  { id: 'artist-spotlight',  name: 'Homepage Spotlight',       description: 'Featured on the TMI homepage for 24 hours',          price: 4900,  priceId: process.env.STRIPE_PRICE_ARTIST_SPOTLIGHT ?? '', icon: '⭐', category: 'boosts',        creatorSplit: 0,    mode: 'payment' },
...
export const FAN_ITEMS: StoreItem[] = [
  ...
  { id: 'fan-club-RUBY',   name: 'Fan Club RUBY',          description: 'Monthly fan club membership — RUBY',               price: 299,   priceId: 'price_fan_club_RUBY',            icon: '🥉', category: 'subscription',  creatorSplit: 0.85, mode: 'subscription' },
...
export const VENUE_ITEMS: StoreItem[] = [
  ...
  { id: 'venue-arena',       name: 'TMI Arena',                description: 'Massive arena for championship events and battles',   price: 9999,  priceId: process.env.STRIPE_PRICE_SPONSOR_ROOM ?? '', icon: '🏟️', category: 'venue', mode: 'payment', badge: 'HOT' },
  ...
  { id: 'venue-cypher',      name: 'Cipher Pit',               description: 'Underground energy — raw, circular, electric',       price: 1499,  priceId: process.env.STRIPE_PRICE_BOOKING_FEE ?? '', icon: '🔥', category: 'venue', mode: 'payment', badge: 'LAUNCH' },
];
...
export const LOBBY_ITEMS: StoreItem[] = [
  ...
  { id: 'lobby-futuristic',  name: 'Futuristic Space',         description: 'Floating platforms, stars — pure sci-fi',            price: 999,   priceId: 'price_fan_club_RUBY',            icon: '🚀', category: 'lobby', mode: 'payment', badge: 'NEW' },
