...
export const SPLIT_ACTION_PRESETS: Record<string, SplitActionPreset> = {
  "go-live": {
    ...
    primaryIcon: "🔴",
    primaryHref: "/hub/performer?golive=1",
    accentColor: "#FF2DAA",
    menuItems: [
      { id: "instant-stream", label: "Instant Go Live", icon: "⚡", href: "/hub/performer?golive=1&mode=instant", description: "Start broadcast immediately" },
      { id: "private-stage", label: "Private Stage", icon: "🔒", href: "/hub/performer?golive=1&mode=private", description: "Rehearsal and invite-only" },
      { id: "audio-only", label: "Audio Stream Ticker", icon: "📻", href: "/hub/performer?golive=1&mode=audio", description: "Low-bandwidth audio broadcast" },
