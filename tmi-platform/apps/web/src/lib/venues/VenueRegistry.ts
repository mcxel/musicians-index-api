...
export const VENUE_REGISTRY: VenueIdentity[] = [
  {
    ...
    capacity: 12000, occupancyPct: 84, isLive: true, audienceCount: 10080,
  ...
  },
  {
    ...
    capacity: 2400, occupancyPct: 71, isLive: true, audienceCount: 1704,
  ...
  },
  {
    ...
    capacity: 800, occupancyPct: 90, isLive: true, audienceCount: 720,
  ...
  },
  {
    ...
    category: 'Theater', tier: 'Platinum',
    capacity: 1200, occupancyPct: 78, isLive: true, audienceCount: 936,
