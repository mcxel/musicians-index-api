-- CreateEnum
CREATE TYPE "PerformerType" AS ENUM (
    'RAPPER',
    'SINGER',
    'DJ',
    'PRODUCER',
...
CREATE TABLE "UserPerformerType" (
    ...
    CONSTRAINT "UserPerformerType_userId_type_key" UNIQUE ("userId", "type")
);
...
-- AddForeignKey
ALTER TABLE "UserPerformerType"
    ADD CONSTRAINT "UserPerformerType_userId_fkey"
