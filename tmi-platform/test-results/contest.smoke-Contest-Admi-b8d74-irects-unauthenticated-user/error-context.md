...
- Name: contest.smoke.spec.ts >> Contest Admin Route Protection >> GET /contest/admin/contestants → redirects unauthenticated user
- Location: tests\e2e\contest.smoke.spec.ts:55:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/contest/admin/contestants
Call log:
  - navigating to "http://localhost:3001/contest/admin/contestants", waiting until "load"
