...
- Name: contest.smoke.spec.ts >> Contest Admin Route Protection >> GET /contest/admin → redirects unauthenticated user
- Location: tests\e2e\contest.smoke.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/contest/admin
Call log:
  - navigating to "http://localhost:3001/contest/admin", waiting until "load"
