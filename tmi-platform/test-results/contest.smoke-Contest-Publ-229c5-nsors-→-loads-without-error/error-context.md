...
- Name: contest.smoke.spec.ts >> Contest Public Routes >> GET /contest/sponsors → loads without error
- Location: tests\e2e\contest.smoke.spec.ts:35:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/contest/sponsors
Call log:
  - navigating to "http://localhost:3001/contest/sponsors", waiting until "load"
