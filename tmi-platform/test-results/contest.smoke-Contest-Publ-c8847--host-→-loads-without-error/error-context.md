...
- Name: contest.smoke.spec.ts >> Contest Public Routes >> GET /contest/host → loads without error
- Location: tests\e2e\contest.smoke.spec.ts:40:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/contest/host
Call log:
  - navigating to "http://localhost:3001/contest/host", waiting until "load"
