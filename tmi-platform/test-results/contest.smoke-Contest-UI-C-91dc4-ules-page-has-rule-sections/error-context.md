...
- Name: contest.smoke.spec.ts >> Contest UI Components >> Contest rules page has rule sections
- Location: tests\e2e\contest.smoke.spec.ts:143:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/contest/rules
Call log:
  - navigating to "http://localhost:3001/contest/rules", waiting until "load"
